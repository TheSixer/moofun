...
angular.module('moofunApp')
    .controller('AnalysisuserCtrl', function ($scope, UserAnalysisEntity,$window, $controller, Util,$confirm, $filter, API_END_POINT,$httpParamSerializer) {
        ...
        var parentCtrl = $controller('BaseListCtrl', {
            $scope: $scope, CRUDServices: UserAnalysisEntity, config: {
                filter: {
        ...
        $scope.exportExcel = function () {
            var url = API_END_POINT.url + '/information/daily/excel?' + $httpParamSerializer(formateDate($scope.filter));
